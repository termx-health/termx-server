...
import org.termx.taskforge.task.TaskSearchParams;
...
public class TaskMapper {
  ...
  public Task map(com.kodality.termx.task.Task termxTask) {
    ...
    task.setCreatedBy(new TaskforgeUser().setSub(termxTask.getCreatedBy()));
    task.setCreatedAt(termxTask.getCreatedAt());
    task.setAssignee(new TaskforgeUser().setSub(termxTask.getAssignee()));
    task.setUpdatedBy(new TaskforgeUser().setSub(termxTask.getUpdatedBy()));

package com.kodality.termserver.ext.ucum;
...
public class UcumValueSetExpandProvider extends ValueSetExternalExpandProvider {
  ...
  public UcumValueSetExpandProvider(ValueSetVersionRuleSetService valueSetVersionRuleSetService,
                                    UcumMapper ucumMapper, MeasurementUnitService measurementUnitService) {

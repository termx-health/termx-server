...
public class IchiUzController {
  ...
  @Post("/import")
  public JobLogResponse importIchiUz(@NonNull @QueryValue String url, @Body @Valid @NonNull ImportConfiguration configuration) {
    ...
    CompletableFuture.runAsync(SessionStore.wrap(() -> {
      try {
        ...
        log.error("Error while importing ICHI uz (TE700)", e);

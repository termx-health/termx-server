...
import com.kodality.termserver.integration.icd10est.utils.Icd10Est.Chapter;
...
public class Extractor {
  ...
  public static List<Concept> parseDiagnoses(List<Icd10Est> diagnoses, ImportConfiguration configuration, List<EntityProperty> properties) {
    ...
    concepts.add(Icd10EstMapper.rootConcept(configuration, properties));
    diagnoses.forEach(d -> concepts.addAll(parseNodeChild(d.getChapter(), rootNode(), configuration, properties)));
    return concepts;
  }

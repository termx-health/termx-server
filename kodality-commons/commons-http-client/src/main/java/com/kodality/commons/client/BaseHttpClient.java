...
import com.kodality.commons.client.HttpClientError.Response;
...
public class BaseHttpClient {
  ...
  private <T> CompletableFuture<HttpResponse<T>> executeAsync(HttpRequest request, BodyHandler<T> bodyHandler) {

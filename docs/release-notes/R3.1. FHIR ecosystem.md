...
- **[FHIR Terminology Ecosystem Registry Proxy](../features/fhir-terminology-ecosystem-registry-proxy.md)** - Consolidated guide: business overview (incl. HTX Router/Viewer context), deployment, API reference, and web UI
...
- Quick reference: [fhir-terminology-ecosystem-registry-proxy.md](../features/fhir-terminology-ecosystem-registry-proxy.md)

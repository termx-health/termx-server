...
- **FHIR Terminology Ecosystem** — Discovery and resolution of terminology servers (HL7 coordination patterns), **REST** endpoints, and optional **web UI** under `/tx-ecosystem/`. See the index: [fhir-terminology-ecosystem-registry-proxy.md](../features/fhir-terminology-ecosystem-registry-proxy.md) and overview: [fhir-terminology-ecosystem-registry-proxy.md](../features/fhir-terminology-ecosystem-registry-proxy.md). **Example HTX demos:** [router (gateway)](https://tx.hl7.lt) · [viewer (browser)](https://htx.hl7.ee).
...
A one-page **A4-style** brief: [R3.1. business-change-summary-2025-01-2026-03-a4.md](./R3.1.%20business-change-summary-2025-01-2026-03-a4.md).
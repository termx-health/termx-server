...
- **Ecosystem:** **FHIR Terminology Ecosystem** discovery/resolution API and optional **web UI**—see [fhir-terminology-ecosystem-registry-proxy.md](../features/fhir-terminology-ecosystem-registry-proxy.md). **HTX demos:** [router](https://tx.hl7.lt) · [viewer](https://htx.hl7.ee).

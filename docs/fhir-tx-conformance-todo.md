...
**Status:** 2026-06-20 · **Last measured baseline:** `318/599` (53.1%) — P5a/P11/abstract/**P9a** done against `hl7.fhir.uv.tx-ecosystem#current` (tests v1.90, runner v6.9.10). **Merged since, NOT yet re-measured:** P7 enum `abstract` (#287), P6a supplement-missing 404 (#288), P6b.1 used-supplement echo (#289, in review) — a fresh conformance run is needed to confirm the delta.

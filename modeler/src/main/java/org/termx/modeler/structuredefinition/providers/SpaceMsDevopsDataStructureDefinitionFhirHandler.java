...
import static org.termx.modeler.structuredefinition.StructureDefinitionUtils.*;

@Slf4j
@Singleton
@RequiredArgsConstructor
public class SpaceMsDevopsDataStructureDefinitionFhirHandler implements SpaceMsDevopsDataHandler {

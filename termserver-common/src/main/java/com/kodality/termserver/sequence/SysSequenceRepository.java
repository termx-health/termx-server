...
import com.kodality.termserver.sequence.SysSequence.SysSequenceLuv;
import com.kodality.termserver.sequence.SysSequenceQueryParams.Ordering;
...
public class SysSequenceRepository extends BaseRepository {
  ...
  public boolean exists(SysSequence sequence) {
